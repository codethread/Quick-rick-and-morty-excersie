...
function getCharacterDataFromCharacterIds(characterIds) {
...
function getEpisodeUrlsFromCharacterData(_a) {
    var episode = _a.episode;
    return episode;
}
function getIdsFromUrls(urls) {
    return urls.map(function (url) { return url.split('/').pop(); });
}
...
function getCharacterUrlsFromEpisodeData(episodeData) {
    return episodeData.reduce(function (characters, episode) {
        return characters.concat(episode.characters);
    }, []);
}
...
function removeCharacterUrlFor(characterId) {
    return function (characterUrls) {
        return characterUrls.filter(function (character) {
            return character !== "https://rickandmortyapi.com/api/character/" + characterId;
        });
    };
}
